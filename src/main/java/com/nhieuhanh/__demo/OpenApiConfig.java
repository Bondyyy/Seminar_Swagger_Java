    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description("Đây là tài liệu API mô phỏng")
                        .contact(new Contact()
                                .name("Huỳnh Đức Dũng - Bondy")
                                .email("bondy@example.com")
                                .url("https://github.com/Bondyyy"))
                        .license(new License().name("Apache 2.0").url("http://springdoc.org")))
                .servers(List.of(
                        new Server().url("http://localhost:8080").description("Môi trường Dev"),
